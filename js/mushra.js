...
function Results2JSON() {
   ...
   const prolific = params.get("PROLIFIC_PID");

    var results = {
        ratings: TestState.Ratings,
        name: $('#UserName').val(),
        id: prolific
    };
        ...
        $.ajax({
                ...
                .done( function (response){
                        if (response.error=="false") {
                                $('#SubmitBox').html("Your submission was succesful.<br/><br/><strong><font color=red>* IMPORTANT * </font> Please click the following link to complete this test.</strong><br/><br/><a href=" + TestData.ReturnURL + ">" + TestData.ReturnURL + "</a><br/><br/><br/>");
